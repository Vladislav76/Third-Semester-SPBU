...
public class Addition {
    ...
    private void parallelPrefixScan() {
        ...
        while (currentOperationsNumber > 0) {
            work.process(step, currentOperationsNumber, step - 1, fun);
            step *= 2;
            currentOperationsNumber = maxLength / step;
        }
        fun.process(maxLength - 1, maxLength - 1 - (step / 2 - 1));
        ...
        while (step >= 2) {
            ...
            work.process(step, currentOperationsNumber,step + (step / 2) - 1, fun);
            step /= 2;
        }
    }
